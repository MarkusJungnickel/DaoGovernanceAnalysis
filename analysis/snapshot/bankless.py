...
###################### READ CSVS ###########################
proposals = genfromtxt('../../Snapshot/bankless/proposals.csv',
                       delimiter="//")
...
proposalsStr = genfromtxt(
    '../../Snapshot/bankless/proposals.csv', delimiter="//", dtype=str)
...
s2 = sns.jointplot(x=propOutcomes[:, 4], y=propOutcomes[:, 1], kind="hex",
                   norm=mpl.colors.LogNorm(), marginal_kws=dict(bins=13), joint_kws=dict(gridsize=20), color="#4CB391")
